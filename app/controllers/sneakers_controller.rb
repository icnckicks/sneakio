class SneakersController < ApplicationController
  ...
  private
    ...
    def sneaker_params
      params.require(:sneaker).permit(:brand, :name, :size, :size_category, :quantity, :purchase_price, :purchase_date, :colorway, :source, :return_period, :sale_price, :sold, :sku, :payout)
    end    
end
